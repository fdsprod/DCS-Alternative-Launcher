...
{
    public class TripleRangeSliderAdvancedOptionModel : MultiValueAdvancedOptionModel<double>
    {
        public TripleRangeSliderAdvancedOptionModel(AdvancedOption option)

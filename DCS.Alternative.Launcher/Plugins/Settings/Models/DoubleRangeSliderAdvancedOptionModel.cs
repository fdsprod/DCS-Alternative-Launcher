...
{
    public class DoubleRangeSliderAdvancedOptionModel : MultiValueAdvancedOptionModel<double>
    {
        public DoubleRangeSliderAdvancedOptionModel(AdvancedOption option)

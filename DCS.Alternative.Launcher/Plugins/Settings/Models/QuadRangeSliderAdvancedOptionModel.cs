...
{
    public class QuadRangeSliderAdvancedOptionModel : MultiValueAdvancedOptionModel<double>
    {
        public QuadRangeSliderAdvancedOptionModel(AdvancedOption option)
            : base(option.Id, option.DisplayName, option.Description, option.Params)
        {
            ...
            Value4.Subscribe(_ => SignalValueChanged());
        }
        ...
        public ReactiveProperty<double> Value4
        {
            get;
        } = new ReactiveProperty<double>();

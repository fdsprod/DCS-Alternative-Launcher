...
namespace DCS.Alternative.Launcher
{
    internal class UserFriendlyExceptionHandler : GeneralExceptionHandler
    {
        protected override Task OnErrorOverrideAsync(Exception e)
        {
            ...
            MessageBoxEx.Show($"An error has occured and has been copied to your clipboard.   Please report the error to the developer.{Environment.NewLine}{message}", "General Exception");
